...
2. On my Arch i3wm setup YAD is not set by default as floating (unlike Zenity). The easiest workaround i found was adding to my i3wm config file the line   `for_window [title="YAD"] floating enable `  
